...
<form class="form-horizontal">
    <fieldset>
        <div class="form-group">
            <label class="col-lg-4 control-label">{{Adresse IP de la box}}</label>
            <div class="col-lg-2">
                <input class="configKey form-control" data-l1key="tydom::host" />
            </div>
        </div>
        <div class="form-group">
            <label class="col-lg-4 control-label">{{Adresse mac de la box}}</label>
            <div class="col-lg-2">
        ...
        <div class="form-group">
            <label class="col-lg-4 control-label">{{Acces distant}}</label>
            <div class="col-lg-2">
                <input type="checkbox" class="configKey form-control" data-l1key="tydom::remote" />
            </div>
        </div>
    </fieldset>
</form>
